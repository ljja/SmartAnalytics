...
namespace SmartAnalytics.Report.Areas.Visitor.Controllers
{
    ...
    /// </summary>
    [UserAuthorization]
    public class ActivityDegreeController : Controller
    {
        ...
        public ActionResult Index(string domain = "www.baidu.com", string date = "")
        {
            ...
            var pageResult = _visitorService.GetVisitorActiveListByDay(domain, DateTime.Parse(currentDate.ToString("yyyy-MM-dd")));
